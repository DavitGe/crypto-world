export const institutionalConf = {
  title: "Institutional",
  heading: "High-touch crypto solutions for institutions",
  bgColor: "rgb(240, 242, 246)",
  color: "#677185",
  iconBgColor: "rgb(223, 227, 235)",
  button: {
    ...
    >
      ...
      >
        <path
          ...
          fill="#b1b8c7"
        ></path>
        <path d="m27.9999 8.99998c0-3.99999-5.9999-7.99998-11.9999-7.99998-6.00001 0-12 3.99999-12 7.99998"></path>
        <path
